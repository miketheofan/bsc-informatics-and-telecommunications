...
/* Identifier represents a string. */
Identifier = [_A-Za-z][_A-Za-z0-9]*

/* Function call "trick" that is used in order to specify whether input:
"Identifier()" , is used as top level or lower level call. */
Trick = [)]{WhiteSpace}*[{]
