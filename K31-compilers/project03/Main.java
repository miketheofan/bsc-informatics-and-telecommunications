    ...
    public static void main(String[] args) throws Exception {
        ...
        for(String argument : args){
            ...
            try{
                ...
                String outputFile = argument.substring(0,argument.length()-5);

                /* Calling LLVM visitor. */
                LLVMvisitor third = new LLVMvisitor(symbolTable,outputFile);
                root.accept(third,null); 
                System.err.println("LLVM visitor parsed succesfully.");
