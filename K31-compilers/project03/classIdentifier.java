...
public class classIdentifier{
	...
	/* The following function returns the offset of a function given. */
	public int getFunctionIndex(String function){

		int count = 0;
		for (Map.Entry<String,Method> temp : Methods.entrySet()){

			if(temp.getKey() == function)
				return count;
	...
	/* The following function returns the memory size of this current class. */
	...
	/* The following function returns the offset of a field given. */
